...
% This will start the function 'launch' of the module movement_detection in every node connected to the network of boards.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%     ADDING THE MOVEMENT DETECTION TO THE NUMERL VERSION OF movement_detection     %%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
clear_gesture() ->
    file:write_file("movement_detection/lib/movement_detection-1.0.0/src/gesture", ""),
...
start(_Type, _Args) ->
    {ok, Supervisor} = movement_detection_sup:start_link(),
    init_table(),
    case node_type() of
...
launch(nav) -> % This is the function called by movement_detection:launch() when we are working with a nav.
